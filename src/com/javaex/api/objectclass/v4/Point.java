...
// v3. 복제(얕은 복제)
// 복제: object.clone() 메서드를 사용 -> Cloneable 인터페이스를 구현해야 clone() 메서드 사용 가능
public class Point implements Cloneable {
	// 상속 받은 클래스에서도 접근할 수 있도록 제한을 낮춤
	protected int x;
	protected int y;
	
	// 사용자 정의 생성자가 있을 경우 JVM은 기본생성자를 만들지 않는다
	public Point() {
	...
	// toString: print 혹은 문자열과 연결될 때 호출되어서 내용을 문자열로 변환한다
	@Override
