...
//		stringMethods();
	...
	private static void stringMethods() {
		...
		// 중요! indexOf
		System.out.println("Fun 문자열의 위치 인덱스: " + s.indexOf("Fun")); // 검색어 대소문자를 구분함
		System.out.println("fun 문자열의 위치 인덱스: " + s.indexOf("fun")); // 반환값이 -1 = 찾을 수 없다는 뜻
		...
		// 문자열 분리: split
		String[] chunks = s.split(" "); // 공백을 기준으로 분리 -> 문자열 배열
