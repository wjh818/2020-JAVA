...
//		whileEx3();
	...
	public static void whileEx3() {
		// while은 종료를 위한 제어 변수를 잘 제어하여 무한루프에 빠지지 않도록 해야 한다
		// 하지만 경우에 따라서는 의도적으로 무한루프를 사용하기도 한다
	...
	public static void whileEx() {
		// 반복문을 사용해서 1부터 100까지의 숫자를 합산하여 출력
		int num = 1; //시작값, 조건 비교
		int total = 0; //합산 변수
	...
	public static void switchEx() {
		...
		case 4:
			...
			break;
		default: //else 위에 case문에서 일치하는 결과 없을 때
	...
	public static void ifElseEx3() {
		//과목번호 입력
		//1 -> R101, 2 -> R202, 3 -> R303, 4 -> R404. 나머지는 관리자에게 문의
		Scanner scanner = new Scanner(System.in);
		System.out.println("1:C, 2:C++, 3:Java, 4:Python -");
