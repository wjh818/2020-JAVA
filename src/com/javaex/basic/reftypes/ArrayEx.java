...
//		arrayCopy();
	...
	public static void arrayCopy() {
		// 배열은 크기 변경이 안되기 때문에 추가 내용이 있을 경우 새 배열 생성 후 복사해야함
		int scores[] = {80, 90, 70};
		// 공간 7개 추가
		int target[] = new int[10];
	...
	public static void arrayMemoryTest() {
		...
		System.out.println("scores2의 0번 방: " + scores2[0]); //scores2도 같이 바뀜
	}
	...
	public static void arrayBasic() {
		...
		scores[2] = 85;
		scores[3] = 88;
//		scores[4] = 100; //Error -> 길이가 4이므로 방 번호는 3까지
